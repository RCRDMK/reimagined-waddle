...
<section class="body">
    <div class="rechtliches">
        ...
        <p>Max Muster<br>Musterweg 1<br>12345 Musterstadt</p>
        E-Mail-Adresse: <p><a href="mailto:muster@mail.de">muster@mail.de</a></p>
        <p><a href="impressum.php" target="_blank">Impressum</a>
        </p>
        ...
        <p>Zu den Maßnahmen gehören insbesondere die Sicherung der Vertraulichkeit, Integrität und Verfügbarkeit von
            ...
            Voreinstellungen.</p>
        <p>SSL-Verschlüsselung (https): Um Ihre via unserem Online-Angebot übermittelten Daten zu schützen, nutzen wir
        ...
        <p><strong>Hinweise zu datenschutzrechtlichen Rechtsgrundlagen: </strong>Auf welcher datenschutzrechtlichen
            ...
            verarbeiteten Daten auf Grundlage unserer berechtigten Interessen (z.B. an einem betriebswirtschaftlichen
            Betrieb unseres Onlineangebotes und Verbesserung seiner Nutzbarkeit) verarbeitet oder, wenn dies im Rahmen
        ...
        <ul>
            <li><strong>Temporäre Cookies (auch: Session- oder Sitzungs-Cookies):</strong> Temporäre Cookies werden
                ...
                oder mobile Applikation) geschlossen hat. Diese Cookies sind für die Benutzung von ReiWa absolut
                notwendig und werden bei jeden Besuch erhoben.
            </li>
        </ul>
        ...
        <ul class="m-elements">
            <li><strong>Registrierung mit Pseudonymen: </strong>Nutzer dürfen statt Klarnamen Pseudonyme als Nutzernamen
                verwenden; <strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6
            ...
            <li><strong>Profile der Nutzer sind öffentlich: </strong>Die Profile der Nutzer sind öffentlich sichtbar und
                zugänglich; <strong>Rechtsgrundlagen:</strong> Vertragserfüllung und vorvertragliche Anfragen (Art. 6
                Abs. 1 S. 1 lit. b. DSGVO).
            </li>
            <li><strong>Löschung von Daten nach Kündigung: </strong>Wenn Nutzer ihr Nutzerkonto gekündigt haben, werden
                ...
                Einwilligung der Nutzer, gelöscht; <strong>Rechtsgrundlagen:</strong> Vertragserfüllung und
