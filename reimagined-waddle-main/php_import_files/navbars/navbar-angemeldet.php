        ...
        <ul id="navbar-liste">
            ...
            <li><a class="nav-elemente" id="profil" href="profil.php">Profil</a></li>
            <li><a class="nav-elemente" id="abmelden" href="php_import_files/abmelden-logik.php">Abmelden</a></li>
        ...
        <label id="hamburger-menu" for="hamburger-check">
          <nav id="hamburger" aria-label="Menü für Smartphones">
            ...
            <li><a href="index.php"><img id="hamburger-home-logo" src="ressourcen/logo.png" alt="home" width="100" height="100"/></a></li>
             <li><a id="hamburger-profil" href="profil.php">Profil</a></li>
            <li><a id="hamburger-abmelden" href="php_import_files/abmelden-logik.php">Abmelden</a></li>
